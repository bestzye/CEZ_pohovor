import datetime #knihovna pro datum a cas (time stamp)
import time #knihovna s funkci sleep
import pandas as pd #knihovna pro analýzu dat pandas
from yahoofinancials import YahooFinancials #knihovna pro stahovani informaci z Yahoo!Finance
...
def time_stamp():
    '''vytvori time_stamp (UTC) ve formátu DD/MM/YYYY HH:MM:SS'''
